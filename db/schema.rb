...
ActiveRecord::Schema.define(version: 20170121210301) do
  ...
  create_table "follows", force: :cascade do |t|
    ...
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["followable_id", "followable_type", "user_id"], name: "index_follows_on_followable_id_and_followable_type_and_user_id", using: :btree
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.datetime "updated_at",                  null: false
    t.integer  "user_id"
    t.boolean  "check_follow", default: true, null: false
